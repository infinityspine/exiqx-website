 ...
 * - Enlarged logo for stronger brand presence
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="mb-6 flex items-center">
              <Image
                ...
                width={320}
                height={100}
                className="h-20 w-auto max-w-[320px] sm:h-24"
                priority
              />
            </div>
            ...
            <div className="mt-6 flex gap-4">
              ...
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/60 transition-all hover:border-accent hover:text-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-black"
