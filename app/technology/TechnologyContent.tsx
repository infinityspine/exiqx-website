    ...
    <section className="min-h-screen bg-black flex items-center justify-center">
      <div className="max-w-5xl mx-auto px-8 py-28 md:py-36 text-left md:pl-4">
        ...
        >
          ...
          <h2 className="text-5xl font-extrabold uppercase tracking-tight mb-6 text-white mt-80">
          ...
          <div className="mt-80">
            ...
            <Link
              href="/specifications"
              className="text-lg md:text-xl text-gray-300 underline decoration-[#e50914] decoration-2 underline-offset-4 hover:text-white transition-colors duration-300"
            >
