        ...
        <div className="w-full space-y-16">
          ...
          <div className="grid w-full min-w-0 items-center gap-8 lg:grid-cols-2">
            ...
            <motion.div 
              ...
              transition={{ type: "spring", stiffness: 180, damping: 20 }}
              className="relative w-full min-w-0 max-w-full aspect-[3/2] overflow-hidden border border-zinc-800/60 bg-black transition-all duration-300 hover:border-red-900/50 will-change-transform"
              style={{ transform: 'translateZ(0)' }}
            >
              <Image
          ...
          <div className="grid w-full min-w-0 items-center gap-12 sm:gap-16 lg:grid-cols-2 lg:gap-12">
            ...
            <motion.div 
              variants={fadeUp}
              className="relative w-full min-w-0 max-w-full aspect-[3/2] overflow-hidden lg:order-2 border border-zinc-800/60 bg-black transition-all duration-300 hover:border-red-900/50 will-change-transform"
              whileHover={shouldReduceMotion ? {} : { 
                y: -6, 
                scale: 1.02,
                transition: { type: "spring", stiffness: 180, damping: 20 }
