...
const RackSpecsPropsSchema = z.object({
  ...
  imageSrc: z.string().default('/rack-mounted-detail.jpg'),
  imageAlt: z.string().default('Product specifications detail'),
  imagePosition: z.enum(['left', 'right']).default('right'),
  className: z.string().optional(),
})

type RackSpecsProps = z.infer<typeof RackSpecsPropsSchema>
...
const RackSpecs = memo<Partial<RackSpecsProps>>((props) => {
  const validatedProps = RackSpecsPropsSchema.parse(props)
  const {
    title,
    subtitle,
    specs,
...
RackSpecs.displayName = 'RackSpecs'

export default RackSpecs
export type { RackSpecsProps }