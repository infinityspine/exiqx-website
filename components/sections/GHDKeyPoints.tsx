...
const GHDKeyPointsPropsSchema = z.object({
...
type GHDKeyPointsProps = z.infer<typeof GHDKeyPointsPropsSchema>
...
const GHDKeyPoints = memo<Partial<GHDKeyPointsProps>>((props) => {
  const validatedProps = GHDKeyPointsPropsSchema.parse(props)
  ...
  return (
    ...
    >
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, margin: '-100px' }}
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 sm:px-6 lg:px-8 max-w-[87.5rem] mx-auto items-stretch"
        >
            ...
            return (
              ...
              >
                <motion.div
                  ...
                  className="bg-[#111111] border border-red-600/20 rounded-lg px-6 py-8 lg:px-8 lg:py-10 transition-colors duration-300 hover:border-red-600/40 flex flex-col justify-between w-full h-full min-h-[28rem]"
                >
...
GHDKeyPoints.displayName = 'GHDKeyPoints'

export default GHDKeyPoints
export type { GHDKeyPointsProps }
