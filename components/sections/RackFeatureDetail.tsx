...
const RackFeatureDetailPropsSchema = z.object({
  title: z.string().default('Precision-Mounted Stability'),
  ...
  imageSrc: z.string().default('/rack-mounted-side.jpg'),
  imageAlt: z.string().default('Product feature detail'),
  imagePosition: z.enum(['left', 'right']).default('left'),
  className: z.string().optional(),
})

type RackFeatureDetailProps = z.infer<typeof RackFeatureDetailPropsSchema>
...
const RackFeatureDetail = memo<Partial<RackFeatureDetailProps>>((props) => {
  const validatedProps = RackFeatureDetailPropsSchema.parse(props)
  const {
    title,
    description,
    features,
...
RackFeatureDetail.displayName = 'RackFeatureDetail'

export default RackFeatureDetail
export type { RackFeatureDetailProps }