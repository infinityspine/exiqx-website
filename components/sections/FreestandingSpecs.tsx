...
const FreestandingSpecsPropsSchema = z.object({
  ...
  imageSrc: z.string().default('/freestanding-detail.jpg'),
  imageAlt: z.string().default('Product specifications detail'),
  imagePosition: z.enum(['left', 'right']).default('right'),
  className: z.string().optional(),
})

type FreestandingSpecsProps = z.infer<typeof FreestandingSpecsPropsSchema>
...
const FreestandingSpecs = memo<Partial<FreestandingSpecsProps>>((props) => {
  const validatedProps = FreestandingSpecsPropsSchema.parse(props)
  const {
    title,
    subtitle,
    specs,
...
export type { FreestandingSpecsProps }
