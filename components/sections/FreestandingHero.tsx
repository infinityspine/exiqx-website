  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="z-0 w-full -mt-20 lg:mt-0 lg:w-[55%] lg:flex-shrink-0 will-change-transform overflow-visible lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2"
      >
