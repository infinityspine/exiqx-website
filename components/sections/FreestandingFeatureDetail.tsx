...
const FreestandingFeatureDetailPropsSchema = z.object({
  title: z.string().default('Rack-Free Performance'),
  ...
  imageSrc: z.string().default('/freestanding-side.jpg'),
  imageAlt: z.string().default('Product feature detail'),
  imagePosition: z.enum(['left', 'right']).default('left'),
  className: z.string().optional(),
})

type FreestandingFeatureDetailProps = z.infer<typeof FreestandingFeatureDetailPropsSchema>
...
const FreestandingFeatureDetail = memo<Partial<FreestandingFeatureDetailProps>>((props) => {
  const validatedProps = FreestandingFeatureDetailPropsSchema.parse(props)
  const {
    title,
    description,
    features,
...
FreestandingFeatureDetail.displayName = 'FreestandingFeatureDetail'

export default FreestandingFeatureDetail
export type { FreestandingFeatureDetailProps }
