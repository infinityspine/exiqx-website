...
const HeroSection = memo(function HeroSection({
  ...
  return (
    ...
    >
      ...
      {/* MOBILE - ELITE */}
      <div className="lg:hidden bg-black relative min-h-[100dvh] overflow-hidden">
        ...
        {!shouldReduceMotion && (
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <motion.div
              ...
              className="absolute top-[40%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] bg-gradient-radial from-red-600/40 via-red-900/15 to-transparent blur-3xl"
            />
          </div>
        )}
        ...
        {/* Product Image - MASSIVE & DOMINANT */}
        <div className="absolute top-0 left-0 right-0 h-[85vh] flex items-center justify-center">
          ...
          {!shouldReduceMotion && (
            <motion.div
              ...
              className="absolute inset-0 bg-gradient-radial from-red-500/30 via-red-600/10 to-transparent blur-3xl"
            />
          )}
          ...
          <img
            src="/images/footplate-hero.png"
            alt={validatedData.backgroundImageAlt}
            className="w-[180%] max-w-[900px] h-auto object-contain relative z-10"
            style={{
        ...
        <div className="absolute top-[55vh] left-0 right-0 z-20 px-6">
          <h1 
            className="text-[clamp(2.5rem,8vw,3.2rem)] leading-[0.95] font-black text-white tracking-[-0.02em] text-center mb-6"
            style={{
          ...
          {/* Subheadline */}
          <p className="text-[clamp(1.05rem,3.5vw,1.2rem)] text-white/90 leading-[1.55] mb-8 max-w-lg mx-auto text-center">
            {validatedData.subheadline}
          </p>
        </div>

        {/* CTAs & Tagline at Bottom */}
        <div className="absolute bottom-0 left-0 right-0 z-20 px-6 pb-10 pt-20 bg-gradient-to-t from-black via-black/95 to-transparent">
