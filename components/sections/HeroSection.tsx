    ...
    >
      ...
      <div className="lg:hidden">
        ...
        <div className="relative min-h-[100dvh] bg-black overflow-hidden">
          ...
          <div className="absolute bottom-[-15vh] left-0 right-0 z-10 px-5 pb-[max(env(safe-area-inset-bottom),1.5rem)] pt-32 bg-gradient-to-t from-black via-black to-transparent">
