  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute right-0 top-0 bottom-0 flex items-center justify-end w-3/5 will-change-transform"
      >
        <div className="relative w-full h-[85vh] mr-[-5%]">
          <img
