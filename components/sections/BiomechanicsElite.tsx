        ...
        >
          ...
          >
            <motion.h2
              ...
              variants={fadeUp}
              className="font-display text-3xl md:text-4xl lg:text-5xl font-extrabold uppercase tracking-tight text-white text-center leading-[1.2] max-w-5xl mx-auto flex flex-col gap-2"
            >
            ...
            <motion.p
              variants={fadeUp}
              className="mt-14 md:mt-16 text-base md:text-lg lg:text-xl font-medium text-gray-200/90 leading-relaxed max-w-4xl mx-auto text-center space-y-2"
            >
